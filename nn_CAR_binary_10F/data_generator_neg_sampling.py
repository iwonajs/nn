...
class DeepTrace_DataGenerator(tf.keras.utils.Sequence):
    ...
    def __init__(self, configs, data_source, feed_flag, validation_fold=-1, train_mode=True):
        ...
        self.cases = len(self.pos_triplets) *2
    ...
    def set_neg_triplets(self):
        ...
        for k, v in self.data.items():
            ...
            self.neg_triplets += [[v["cfm_npz"], new_bug_id, v["pos"]]]
...
if __name__ == "__main__":
    ...
    gen = DeepTrace_DataGenerator(configs, configs["train_pos_folds"], "CAR",
                                  validation_fold=0,
                                  train_mode=True)
    ...
    gen = DeepTrace_DataGenerator(configs, configs["test_pos"], "CAR",
                                  validation_fold=-1,
                                  train_mode=False)
