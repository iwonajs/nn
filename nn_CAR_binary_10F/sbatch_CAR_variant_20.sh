...
python ./run_terminal.py -n $SLURM_ARRAY_TASK_ID -u 10 -m 20 --chkpt True --flat 1
tar -cf ~/projects/def-miranska/iwonajs/nn_CAR_binary_10F/CAR_variant_20_$SLURM_ARRAY_TASK_ID.tar results
